...
class Config:
    ...
    # 头像上传目录
    UPLOAD_ICON_FOLDER = os.path.join(BASE_DIR, 'upload\icon')
    # 相册上传目录
    # UPLOAD_PHOTO_FOLDER = os.path.join(STATIC_DIR, 'upload/photo')

    #11.设置recaptcha的公钥和私钥
    RECAPTCHA_PUBLIC_KEY = '6LcKgAEsAAAAAJ29pVEYtx5yKyJuVo5n_qDJj2S6'
    RECAPTCHA_PRIVATE_KEY = '6LcKgAEsAAAAAFfZ8l_Zz7Zd7Xu0saHngNMugvgR'
